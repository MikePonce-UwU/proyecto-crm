@extends('layouts.adminlte', ['breadcrumbs_title' => 'Create client', 'title' => 'Creating a client'])
@section('content')
    <div class="content">
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="card card-outline card-success">
                    <div class="card-header">{{ __('Create a client') }}</div>
                    <div class="card-body">
                            ...
                            <fieldset class="row mb-3 border rounded py-4">
                                ...
                                <div class="input-group col-md-4 col-12">
                                    ...
                                    <input id="contact_phone_number" type="text"
                                        ...
                                        value="{{ old('contact_phone_number', '') }}" autofocus
                            ...
                            <fieldset class="row mb-3 border rounded py-4">
                                ...
                                <div class="input-group col-md-4 col-12">
                                    ...
                                    <input id="company_address" type="text"
                                        ...
                                        value="{{ old('company_address', '') }}" autofocus
                                ...
                                <div class="input-group col-md-4 col-12">
                                    ...
                                    <input id="company_phone_number" type="text"
                                        ...
                                        value="{{ old('company_phone_number', '') }}" autofocus
