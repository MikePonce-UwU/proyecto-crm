@extends('layouts.adminlte', ['breadcrumbs_title' => 'Create role', 'title' => 'Creating a role'])
@section('content')
    <div class="content">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.roles.store') }}" method="post" id="form">
                            ...
                            <fieldset class="row mb-3 border rounded py-4">
                                <legend class="pl-2">Role details</legend>
                                {{-- Name --}}
                                <div class="input-group col-md-6 col-12 mb-4 mb-sm-0">
                                    <input id="name" type="text"
                                        class="form-control @error('name') is-invalid @enderror" name="name"
                                        value="{{ old('name', '') }}" autofocus placeholder="Insert the name">
